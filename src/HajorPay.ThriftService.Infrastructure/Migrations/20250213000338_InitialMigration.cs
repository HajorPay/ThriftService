        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BVN = table.Column<string>(type: "varchar(255)", nullable: false),
                    NIN = table.Column<string>(type: "varchar(255)", nullable: true),
                    OptInForSMS = table.Column<bool>(type: "bit", nullable: false),
                    OptInForEmail = table.Column<bool>(type: "bit", nullable: false),
                    RegisteredByAdmin = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContributionAccount = table.Column<string>(type: "varchar(255)", nullable: false),
                    ...
                    TotalContributions = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    LateFee = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContributionAccount = table.Column<string>(type: "varchar(255)", nullable: false),
                    DisbursementAccount = table.Column<string>(type: "varchar(255)", nullable: false),
                    MadeContribution = table.Column<bool>(type: "bit", nullable: false),
                    ReceivedPayment = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    DefaultingInCurrentCycle = table.Column<bool>(type: "bit", nullable: false),
                    DefaultedCount = table.Column<int>(type: "int", nullable: false),
                    CanPickNumber = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contributor", x => x.Id);
                    table.UniqueConstraint("AK_Contributor_ContributionAccount", x => x.ContributionAccount);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contributor_Group_GroupId",
                        column: x => x.GroupId,
